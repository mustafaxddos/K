        ...
        if user_id not in admin_id:
            if user_id in bgmi_cooldown:
                ...
                if time_since_last_attack < 300:
                    ...
                    response = f"You are on cooldown. Please wait {remaining_time} seconds before running the /mustafa command again."
                    bot.reply_to(message, response)
                return
...
def show_help(message):
 ...
 /mylogs : to check recent attacks.
 /plan : checkout aur bornate rates.

to see admin comands:
 /admincmd : show all admin commanda.
 dm to buy - @SIDIKI_MUSTAFA_47
'''
